...
Partial Class frmEnlaces
    ...
    Private Sub InitializeComponent()
        ...
        Me.combo_exploits.Items.AddRange(New Object() {"Return of the Jodi", "BannerBomb", "BatHax (Batman)", "Yu-Gi-Owned!", "Indiana PWNS!", "Smash Stack USA", "Smash Stack EUR Save", "Smash Stack EUR No Save", "Yu-Gi-Vah! (USA)"})
